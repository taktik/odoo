...
def yaml_import(cr, module, yamlfile, kind, idref=None, mode='init', noupdate=False, report=None):
    ...
    if kind == 'test':
        ...
        cls = type(str(class_name), (YamlUnitTesterInterpreter,), {"__module__": module_name, "initArgs": (
        cr, module, idref, mode, yamlfile.name, report, noupdate, loglevel), "yaml_string": yaml_string})
